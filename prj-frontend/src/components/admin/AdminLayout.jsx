        ...
        <div className="flex min-h-screen font-sans text-[var(--text-primary)] transition-colors duration-500 bg-[var(--bg-primary)]">
            ...
            >
                ...
                <footer className="p-4 border-t border-[var(--border-color)]/50 bg-[var(--bg-secondary)] flex-none overflow-hidden">
                    <div className={`flex items-center gap-3 p-3 rounded-2xl bg-[var(--bg-primary)] border border-[var(--border-color)]/50 transition-all group cursor-pointer hover:bg-[var(--text-primary)] hover:border-[var(--text-primary)] ${!isSidebarOpen ? 'justify-center' : ''}`}>
