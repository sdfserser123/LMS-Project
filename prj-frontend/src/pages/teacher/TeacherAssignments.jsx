...
import { ClipboardList, BookOpen, Calendar, Clock, Loader2, ChevronRight, FileText } from 'lucide-react';
...
export const TeacherAssignments = () => {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
            ...
            <p className="text-[var(--text-secondary)] font-bold animate-pulse uppercase tracking-widest text-xs">Loading assignment ledger...</p>
        </div>
    );
        ...
        <div className="max-w-7xl mx-auto space-y-12 p-4 sm:p-8 animate-in fade-in duration-700">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="space-y-2">
                    ...
                    <p className="text-[var(--text-secondary)] font-medium">Manage and track all student projects across your curriculum.</p>
                </div>
            </header>
            ...
            <div className="grid gap-6">
                {assignments.length === 0 ? (
                    <div className="py-24 flex flex-col items-center justify-center glass-card border-dashed border-2 text-center">
                        ...
                        <p className="text-[var(--text-primary)] font-black uppercase tracking-widest text-sm">No assignments found</p>
                        <p className="text-[var(--text-secondary)] text-sm mt-2 font-medium">Create assignments within your courses to see them listed here.</p>
                    </div>
                ) : (
                    assignments.map((assignment) => (
                        ...
                        >
                            <div className="flex items-center gap-8">
                                <div className="h-16 w-16 rounded-2xl bg-[var(--accent-primary)]/10 flex items-center justify-center text-[var(--accent-primary)] shadow-sm border border-[var(--accent-primary)]/20 group-hover:bg-[var(--accent-primary)] group-hover:text-white transition-all">
                            ...
                            <div className="h-14 w-14 rounded-full bg-[var(--bg-secondary)] flex items-center justify-center text-[var(--text-secondary)] group-hover:bg-[var(--accent-primary)] group-hover:text-white transition-all duration-300 shadow-sm">
